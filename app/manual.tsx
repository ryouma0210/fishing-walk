...
function manualGuides() { return [
  ...
  { title: "6. 3つの物語と装備", text: "日本編47、世界編50、宇宙編50の図鑑を収集。日本編の沖縄ヌシで世界編、世界編の最終ヌシで宇宙編が解放されます。", art: <View style={styles.baitArt}><Text style={styles.bigEmoji}>🗾</Text><Text style={styles.arrow}>→</Text><Text style={styles.bigEmoji}>🌍</Text><Text style={styles.arrow}>→</Text><Text style={styles.bigEmoji}>🌌</Text></View> },
]; }
